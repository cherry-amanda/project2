...
<div class="container py-4">
    <a href="{{ route('admin.package.index') }}" class="btn btn-secondary mb-3"><i class="bi bi-arrow-left"></i> Kembali</a>
    ...
    <div class="card shadow-sm">
        <div class="row g-0">
            <div class="col-md-6">
                ...
                @else
                <img src="{{ asset('images/default.jpg') }}" class="img-fluid" alt="default">
                @endif
            </div>
            ...
            <div class="col-md-6">
                <div class="card-body">
                    ...
                    <p class="text-muted">{{ $package->type == 'paket' ? 'Tipe: Paket' : 'Tipe: Jasa' }}</p>
                    <p class="card-text">{{ $package->deskripsi }}</p>
                    <h5 class="fw-bold mt-3">Total Harga: Rp {{ number_format($package->harga_total, 0, ',', '.') }}</h5>
